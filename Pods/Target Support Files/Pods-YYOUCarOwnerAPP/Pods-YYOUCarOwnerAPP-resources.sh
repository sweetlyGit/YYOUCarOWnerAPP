...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ActivityLib/ActivityLibBundle.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/CZCommonLib/CZCommonLibBundle.bundle"
